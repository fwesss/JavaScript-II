...
// to make a small donation on their behalf for some much needed updates to their facilities.  Each
// business has assigned a representative to attend the event along with a small donation.
...
// largeShirts that contains information about the runners that have a shirt size of L and log the
// result

const largeShirts = runners.filter(largeRunner => largeRunner.shirt_size === 'L');
...
const ticketPriceTotal = runners.reduce((accumulator, runner) => accumulator + runner.donation, 0);
...
// Problem 2
// Names of runners whose names will not fit on their bibs. They will need to legally shorten their
// names in order to compete.
